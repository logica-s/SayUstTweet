...
def Setup():
    ...
    u'[Pp]ython,パイソン',
    u'[Pp]hotoshop,フォトショップ',
    u'[Ii]llustrator,イラストレーター',
...
def str_replace(string):
    ...
    string = string.replace(u'㉑', u'21')
    string = string.replace(u'㉒', u'22')
    string = string.replace(u'㉓', u'23')
    string = string.replace(u'㉔', u'24')
    string = string.replace(u'㉕', u'25')
    string = string.replace(u'㉖', u'26')
    string = string.replace(u'㉗', u'27')
    string = string.replace(u'㉘', u'28')
    string = string.replace(u'㉙', u'29')
    string = string.replace(u'㉚', u'30')
    string = string.replace(u'㉛', u'31')
    string = string.replace(u'㉜', u'32')
    string = string.replace(u'㉝', u'33')
    string = string.replace(u'㉞', u'34')
    string = string.replace(u'㉟', u'35')
    string = string.replace(u'㊱', u'36')
    string = string.replace(u'㊲', u'37')
    string = string.replace(u'㊳', u'38')
    string = string.replace(u'㊴', u'39')
    string = string.replace(u'㊵', u'40')
    string = string.replace(u'㊶', u'41')
    string = string.replace(u'㊷', u'42')
    string = string.replace(u'㊸', u'43')
    string = string.replace(u'㊹', u'44')
    string = string.replace(u'㊺', u'45')
    string = string.replace(u'㊻', u'46')
    string = string.replace(u'㊼', u'47')
    string = string.replace(u'㊽', u'48')
    string = string.replace(u'㊾', u'49')
    string = string.replace(u'㊿', u'50')
